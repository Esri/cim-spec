...
```json
{
  ...
  "symbolLayers": [{
      ...
      "markerGraphics": [{
          ...
          "geometry": {
            "curveRings": [[[13.08, 13.55], {
                  "b": [[13.08, 13.54], [13.08, 13.54], [13.08, 13.54]]
                }, [13.08, 4.52], [8.5, 0.0], [3.92, 4.51], [3.92, 13.55], [3.92, 13.55], {
                  "b": [[8.5, 17.0], [3.92, 16.04], [5.97, 17.0]]
                }, {
                  "b": [[13.08, 13.55], [11.03, 17.0], [13.08, 16.04]]
                }
              ]]
          },
          "symbol": {
...
```json
{
  ...
  "symbolLayers": [{
      ...
      "markerGraphics": [{
          "type": "CIMMarkerGraphic",
          "geometry": {
            "rings": [[[10.51, 12.96], [8.63, 4.02], [2.0, 4.02], [10.5, 18.0], [19.0, 4.02], [12.4, 4.02], [10.51, 12.96]]]
          },
          "symbol": {
            "type": "CIMPolygonSymbol",
            "symbolLayers": [{
...
```json
{
  ...
  "symbolLayers": [{
      ...
      "markerGraphics": [{
          "type": "CIMMarkerGraphic",
          "geometry": {
            "curveRings": [[[17.0, 6.0], [0.0, 6.0], {
                  "b": [[0.25, 8.0], [0.0, 6.0], [0.04, 7.32]]
                }, {
                  "b": [[1.26, 10.51], [0.56, 9.01], [1.26, 10.51]]
                }, {
                  "b": [[5.0, 8.8], [1.26, 10.51], [3.04, 8.8]]
                }, {
                  "b": [[8.5, 11.0], [7.1, 8.8], [8.5, 11.0]]
                }, {
                  "b": [[12.0, 8.85], [8.5, 11.0], [10.0, 8.85]]
                }, {
                  "b": [[15.75, 10.5], [14.1, 8.85], [15.75, 10.5]]
                }, {
                  "b": [[16.75, 8.0], [15.75, 10.5], [16.39, 9.17]]
                }, {
                  "b": [[17.0, 6.0], [16.96, 7.32], [17.0, 6.0]]
                }
              ]]
          },
          "symbol": {
      ...
      "markerGraphics": [{
          "type": "CIMMarkerGraphic",
          "geometry": {
            "curveRings": [[[17.0, 14.39], {
                  "b": [[16.49, 9.7], [17.0, 14.39], [16.99, 11.79]]
                }, {
                  "b": [[8.5, 2.61], [15.12, 4.31], [9.92, 2.61]]
                }, {
                  "b": [[0.51, 9.7], [6.74, 2.61], [1.81, 4.6]]
                }, {
                  "b": [[0.0, 14.39], [0.01, 11.79], [0.0, 14.39]]
                }, [17.0, 14.39]]]
          },
          "symbol": {
            "type": "CIMPolygonSymbol",
