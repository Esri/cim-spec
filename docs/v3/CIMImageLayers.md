...
#### Represents NITF group sub layer. 
...
### CIMNitfGroupSubLayerDefinition 

|Property | Type | Description | 
|---------|--------|--------|
| layers | [string] | The layer URIs of the child layers. 
...
| saturation | long | The saturation value. 
| sharpening | long | The sharpening value. 
...
| anonymous | boolean | A value indicating whether or not this is an anonymous connection. 
