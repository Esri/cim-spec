...
| enable2DSymbolPerspectiveScaling | boolean | A value indicating whether perspective scaling to screen-size is enabled for billboarded 2D symbols. 
...
| geometryURI | string | The URI to the geometry to filter features in the dataset. 
| spatialReference | [SpatialReference](ExternalReferences.md#spatialreference) | The spatial reference of the definition filter geometry. 
...
## CIMGAITErrorLayer
#### Represents Geospatial Analysis Integrity Tool (GAIT) datasets as a layer and draws its errors, exceptions, and areas in need of validation. 
...
### CIMGAITErrorLayerDefinition 

|Property | Type | Description | 
|---------|--------|--------|
| errorWorkspaceConnection | [CIMWorkspaceConnection](CIMVectorLayers.md#cimworkspaceconnection) | The data connection. 
| sourceLayers | [string] | The source feature Layers. 
| pointLayer | string | The path of the point layer in the GAIT Error layer. 
| lineLayer | string | The path of the line layer in the GAIT Error layer. 
| polygonLayer | string | The path of the polygon layer in the GAIT Error layer. 
...
|Property | Type | Description | 
|---------|--------|--------|
| savedMaxScale | double | The maximum scale that is saved when ShowLayerAtAllScales is set to true. 
| savedMinScale | double | The minimum scale that is saved when ShowLayerAtAllScales is set to true. 
| showLayerAtAllScales | boolean | A value indicating whether the layer is visible at all scales. When this value is true, the MinScale and MaxScale properties will be set to zero for the benefit of older CIM clients. 
...
| dataURI | string | The URI of any additional data associated with this template. 
